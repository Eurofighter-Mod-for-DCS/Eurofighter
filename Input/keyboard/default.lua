...
-- Flight Control
{down = device_commands.FBWONOFF, value_down = 1.0, cockpit_device_id = devices.FBW_SYSTEM ,name = _('FBW On/Off'),    category = {_('Flight Control')}},

{down = device_commands.RADAR_UP, value_down = 1.0, cockpit_device_id = devices.RADAR ,name = _('RADAR_UP'),    category = {_('Flight Control')}},
{down = device_commands.RADAR_DOWN, value_down = 1.0, cockpit_device_id = devices.RADAR ,name = _('RADAR_DOWN'),    category = {_('Flight Control')}},
...
{combos = {{key = 'B', reformers = {'RShift'}}}, down = iCommandPlaneFormationLights,  name = _('Formation Lights'), category = _('Systems')},
...
{combos = {{key = 'Enter', reformers = {'RCtrl'}}}, down = iCommandPlane_LockOn_start, up = iCommandPlane_LockOn_finish, name = 'Target Lock', category = 'Sensors'},
