...
pylons_enumeration = {1, 13, 12, 11, 2, 3, 4, 10, 5, 6, 9, 8, 7},
	...
	SFM_Data = {
		...
		aerodynamics = { -- Cx = Cx_0 + Cy^2*B2 +Cy^4*B4
            Cy0        = 0,     
            Mzalfa     = 5.5,  --pitch surface deflection. If = 0 tjhen no pitch input exist
            Mzalfadt   = 1.5,    --0.8 too high values make the aircraft shake and underperform
            kjx        = 4.20,		
            kjz        = 0.00125,	
            Czbe       = -0.016, --0.016,  .25 IS STRONG
            cx_gear    = 0.08,   
            cx_flap    = 0.010,   
            cy_flap    = 0.56,   
            cx_brk     = 0.12, 
            table_data = {
                  --Mach         Cx0   		     Cya     B    		 B4     Omxmax   Aldop      Cymax
					{ 0.000,	 0.0376,	    0.078,	0.0310,		 0.19,	 0.68,	 25.000,	 1.14 },
					{ 0.050, 	 0.038, 	    0.078, 	0.0310, 	 0.19, 	 0.95, 	 25.000, 	 1.15 }, 
					{ 0.100, 	 0.038, 	    0.078, 	0.0310, 	 0.19, 	 1.20, 	 25.000, 	 1.16 },
					{ 0.200,	 0.038,	        0.078,	0.0295,		 0.19,	 2.15,	 25.000,	 1.170 },
					{ 0.300,	 0.038,	        0.076,	0.0295,		 0.19,	 2.80,	 25.000,	 1.177 },
					{ 0.400,	 0.03632,	    0.075,	0.0280,		 0.15,	 3.70, 	 25.000,	 1.184 },
					{ 0.500,	 0.0344,	    0.074,	0.0250,		 0.11,	 4.45, 	 25.000,	 1.192 },
					{ 0.600,	 0.0328,     	0.073,	0.0250,		 0.11,	 4.55,	 25.000,	 1.200 },
					{ 0.700,	 0.0312,	    0.070,	0.0290,		 0.11,	 4.55,	 25.000,	 1.200 },
					{ 0.800,	 0.0304,	    0.068,	0.0318,		 0.13,	 4.50,	 25.000,	 1.200 },
					{ 0.850,	 0.0296,     	0.065,	0.0348,		 0.16,	 4.47,	 25.000,	 1.210 },
					{ 0.900,	 0.0296,	    0.055,	0.0370,		 0.16,	 4.45,	 25.000,	 1.220 },																					
					{ 1.000,	 0.0296,    	0.053,	0.0400, 	 0.16,	 4.10, 	 25.000,	 9.300 },
					{ 1.050,	 0.0296,	    0.052,	0.0428,		 0.16,	 4.07,	 25.000,	 9.300 },
					{ 1.100,	 0.0296,	    0.050, 	0.0459, 	 0.16,	 4.05,	 25.000,	 9.300 },
					{ 1.200,	 0.0296,	    0.049, 	0.0500, 	 0.15,	 4.00, 	 25.000,	 9.300 },
					{ 1.300,	 0.0296,	    0.049, 	0.0529, 	 0.15,	 3.97,	 25.000,	 9.300 },
					{ 1.500,	 0.02976,	    0.049, 	0.0569, 	 0.14,	 3.84,	 25.000,	 9.300 },
					{ 1.700,	 0.03,      	0.048, 	0.0600, 	 0.13,	 3.76,	 25.000,	 9.300 },
					{ 1.850,	 0.03,	        0.048, 	0.0629, 	 0.12,	 3.69,	 25.000,	 9.300 },
					{ 2.000,	 0.03,	        0.048, 	0.0659, 	 0.12,	 3.56,	 25.000,	 9.300 },
					{ 2.200,	 0.03,	        0.048, 	0.0689, 	 0.12, 	 3.45,	 25.000,	 9.300 }, 																	
					{ 2.400,	 0.264,	        0.090, 	1.149, 		 1.69,	 0.70,	 25.000,	 9.300 },
					{ 2.500,	 0.552,	        0.040, 	1.35,		 1.10,	 0.70,	 25.000,	 9.300 },
					{ 3.900,	 0.552,	        0.040, 	1.35,		6.380,	 0.70,	 25.000, 	 9.300 },
            }, -- end of table
        }, -- end of aerodynamics
