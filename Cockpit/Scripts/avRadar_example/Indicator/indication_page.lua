...
for i = -2,2 do
	local   radar_grid_v 				= CreateElement "ceMeshPoly"
			...
			radar_grid_v.init_pos 		= {i*0.45*RS * 20,0,0}
			radar_grid_v.material 		= MFCD_BLUE
...
for i = -2,2 do
	local   radar_grid_v 				= CreateElement "ceMeshPoly"
			...
			radar_grid_v.indices  		= default_box_indices
			radar_grid_v.init_pos 		= {0,i*0.45*RS * 20,0}
			radar_grid_v.material 		= MFCD_BLUE
			radar_grid_v.h_clip_relation= h_clip_relations.COMPARE
			radar_grid_v.level			= RADAR_DEFAULT_LEVEL
			radar_grid_v.isdraw		 	= true
...
local	radar_cursor			   		= CreateElement "ceMeshPoly"
		...
		radar_cursor.init_pos	   		= {0, -0.90*RS*20, 0}
		radar_cursor.material    	 	= MFCD_WHITE_COLOR
...
local	radar_STT_iff			   		= CreateElement "ceMeshPoly"
		...
		radar_STT_iff.material    	 	= MFCD_BLUE--MakeMaterial(nil,{10,10,255,150})
	...
	local 	radar_cursor_range	 					= CreateElement "ceStringPoly"
			...
			radar_cursor_range.material        	= HUD_FONT_WHITE
	...
	local 	radar_bearing_L15	 				= CreateElement "ceStringPoly"
			...
			radar_bearing_L15.material        	= HUD_FONT_WHITE
			radar_bearing_L15.init_pos		  	= {-0.45*RS * 20,0.9*RS * 20,0} 
	...
	local 	radar_bearing_R15				= Copy(radar_bearing_L15)
			...
			radar_bearing_R15.init_pos		= {0.45*RS * 20,0.9*RS* 20,0} 
	...
	local 	radar_bearing_L30				= Copy(radar_bearing_L15)
			...
			radar_bearing_L30.init_pos		= {-0.90*RS * 20,0.9*RS * 20,0} 
	...
	local 	radar_bearing_R30				= Copy(radar_bearing_L15)
			...
			radar_bearing_R30.init_pos		= {0.90*RS * 20,0.9*RS * 20,0} 
...
local	radar_SZ_AZIMUTH			   		= CreateElement "ceMeshPoly"
		...
		radar_SZ_AZIMUTH.material    	 	= MFCD_WHITE_COLOR--MakeMaterial(nil,{10,10,255,150})
	...
	local	radar_SR_AZIMUTH			   		= CreateElement "ceMeshPoly"
	radar_SR_AZIMUTH.name		   		= "radar_SR_AZIMUTH" 
		radar_SR_AZIMUTH.primitivetype		= "triangles"	--"lines"--
		radar_SR_AZIMUTH.vertices	   		= {	
										{-x_size , -y_size},
										{-x_size , y_size},
										{ x_size , y_size},
										{ x_size , -y_size},	
									  }
		radar_SR_AZIMUTH.indices	   		= { 0,1,2,	0,2,3}--{0, 1, 2, 0, 2, 3} 
		radar_SR_AZIMUTH.init_pos	   		= {0.9, -0.9*RS, 0}
		radar_SR_AZIMUTH.material    	 	= MFCD_WHITE_COLOR--MakeMaterial(nil,{10,10,255,150})
		radar_SR_AZIMUTH.isdraw				= true
		radar_SR_AZIMUTH.isvisible			= true
		radar_SR_AZIMUTH.h_clip_relation 	= h_clip_relations.COMPARE
		radar_SR_AZIMUTH.level 				= RADAR_DEFAULT_LEVEL 
		radar_SR_AZIMUTH.collimated			= true
		--radar_SZ_AZIMUTH.parent_element	= "radar_STT"
		radar_SR_AZIMUTH.controllers     	= {
												{"rotate_using_parameter",0,1}
											--{"parameter_in_range",0,0.9,1.1},
											--{"change_color_when_parameter_equal_to_number", 0, 1, 1.0,1.0,0.0},
											} 
		radar_SR_AZIMUTH.element_params  	= {"SCAN_ZONE_ORIGIN_AZIMUTH",}
	Add(radar_SR_AZIMUTH)
	
	x_size = 0.005
	y_size = 1.8

	local	radar_SL_AZIMUTH			   		= CreateElement "ceMeshPoly"
		radar_SL_AZIMUTH.name		   		= "radar_SL_AZIMUTH" 
		radar_SL_AZIMUTH.primitivetype		= "triangles"	--"lines"--
		radar_SL_AZIMUTH.vertices	   		= {	
										{-x_size ,-y_size},
										{-x_size , y_size},
										{ x_size , y_size},
										{ x_size ,-y_size},	
									  }
		radar_SL_AZIMUTH.indices	   		= { 0,1,2,	0,2,3}--{0, 1, 2, 0, 2, 3} 
		radar_SL_AZIMUTH.init_pos	   		= {-0.9, -0.9*RS, 0}
		radar_SL_AZIMUTH.material    	 	= MFCD_WHITE_COLOR--MakeMaterial(nil,{10,10,255,150})
		radar_SL_AZIMUTH.isdraw				= true
		radar_SL_AZIMUTH.isvisible			= true
		radar_SL_AZIMUTH.h_clip_relation 	= h_clip_relations.COMPARE
		radar_SL_AZIMUTH.level 				= RADAR_DEFAULT_LEVEL 
		radar_SL_AZIMUTH.collimated			= true
		--radar_SL_AZIMUTH.parent_element	= "radar_STT"
		radar_SL_AZIMUTH.controllers     	= {
												{"rotate_using_parameter",0,1}
											--{"parameter_in_range",0,0.9,1.1},
											--{"change_color_when_parameter_equal_to_number", 0, 1, 1.0,1.0,0.0},
											} 
			radar_SL_AZIMUTH.element_params  	= {"SCAN_ZONE_ORIGIN_AZIMUTH",}
	Add(radar_SL_AZIMUTH)
