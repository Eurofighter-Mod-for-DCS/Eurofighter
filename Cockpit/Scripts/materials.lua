...
fontdescription["font_Display"] = {
	texture		= IndicationFontPath.."Herc_font_TacView.dds",
	size		= {8, 8},
	resolution	= {1024, 1024},
	default		= {MPCD_xsize, MPCD_ysize},
	chars		= {
	...
	fonts["font_Display"]			= {fontdescription["font_Display"], 10, materials["DBG_WHITE"] }
	fonts["font_Display_green"]			= {fontdescription["font_Display"], 10, {20, 230, 20, 140}}
